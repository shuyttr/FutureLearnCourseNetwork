...
Overall, I used axiom and cheerio to walk through the rendered HTML document, looped through each course via its class name, and added its details to a document. Added that document to an array. Exported that array in JSON format to the file system
